...
@DatabaseView(
    value = """
        ...
        UNION ALL
        SELECT transactionCode, phone, amount, date,time,transactionType, businessBalance, 'OUT' as transactionCategory,'MY MPESA' as name, transactionCost FROM MoveFromPochiEntity
    """
)
