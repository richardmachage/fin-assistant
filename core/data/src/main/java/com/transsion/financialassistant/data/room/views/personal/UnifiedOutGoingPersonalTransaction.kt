...
@DatabaseView(
    value = """
                ...
                UNION ALL
                SELECT transactionCode, phone, amount, date, time, transactionType, "OUT" AS transactionCategory, transactionCost, mpesaBalance, "MOVE TO POCHI" as name FROM MoveToPochiEntity 
